...
import { Modal, Button, Form, Card, InputGroup, Spinner, ListGroup } from 'react-bootstrap';
...
function App() {
  ...
  return (
    <Router>
      <Header toggleOffcanvas={toggleOffcanvas} showOffcanvas={showOffcanvas} />
      {/* Definición de rutas */}
      <Routes>
        ...
        <Route
          ...
          element={
            <div
              style={{
                backgroundImage: 'url(/aeropuerto.jpg)',
                minHeight: '100vh',
                backgroundRepeat: 'no-repeat',
                backgroundSize: '100% 100%',
              }}
            >
              <div className="d-flex flex-column flex-lg-row justify-content-center align-items-start gap-3" >
                ...
                <Card className="p-3 w-75 m-5"  style={{ backgroundColor: '#D9E3F1' }}>
                  ...
                  <Button variant="primary" onClick={toggleHistoryVisibility} className="mt-3 align-self-start" size="sm">
                ...
                {airports.length > 0 && (
                  <Card className="m-5 mr-3 p-3 w-75" style={{ backgroundColor: '#D9E3F1' }}>
                ...
                {selectedAirport && (
                  <Modal show={showModal} onHide={() => setShowModal(false)} size="lg" centered>
                    <Modal.Header closeButton style={{ backgroundColor: '#A2BAD4' }}>
